...
def test_pep440_postrelease_property():
    version = Pep440("1.0.0.post1")
    assert version.postrelease == "post1"

    version = Pep440("1.0.0")
    assert version.postrelease is None


def test_pep440_prerelease_property():
    version = Pep440("1.0.0a1")
