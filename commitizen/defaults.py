...
def __getattr__(name: str) -> Any:
    ...
    deprecated_vars = {
        ...
        "MAJOR": (str(VersionIncrement.MAJOR), "VersionIncrement.MAJOR"),
        "MINOR": (str(VersionIncrement.MINOR), "VersionIncrement.MINOR"),
        "PATCH": (str(VersionIncrement.PATCH), "VersionIncrement.PATCH"),
    }
